package me.huahuadehaoyeye.migrator.core;
...
import me.huahuadehaoyeye.migrator.utils.TextUtil;
...
public class LayoutMigrator {
    ...
    private final QuickBuyMigrator plugin;
    private final YamlConfiguration config;

    public LayoutMigrator(QuickBuyMigrator plugin) {
        this.plugin = plugin;
